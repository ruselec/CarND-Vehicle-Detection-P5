...
Then I wrote functions for getting color, spatial, hog features from the Udasity lessons. The code for this step is contained in the second code cell of the IPython notebook.
